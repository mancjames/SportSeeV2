...
namespace SportSeeV2.Server.Migrations
{
    ...
    [Migration("20240602120139_added-user-performance")]
    partial class addeduserperformance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportSeeV2.Server.Data.PerformanceDataEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("UserPerformanceEntityId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserPerformanceEntityId");

                    b.ToTable("PerformanceDataEntity");
            ...
            modelBuilder.Entity("SportSeeV2.Server.Data.SessionsEntity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("UserAverageSessionsEntityId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserAverageSessionsEntityId");

                    b.ToTable("SessionsEntity");

                    b.HasData(
                        new
                        {
                            id = 1,
                            UserAverageSessionsEntityId = 1,
                            day = 1,
                            sessionLength = 30
                        },
                        new
            ...
            modelBuilder.Entity("SportSeeV2.Server.Data.UserAverageSessionsEntity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("UserAverageSessionsEntity");
            ...
            modelBuilder.Entity("SportSeeV2.Server.Data.UserPerformanceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("UserPerformanceEntity");
            ...
            modelBuilder.Entity("SportSeeV2.Server.Data.PerformanceDataEntity", b =>
                {
                    b.HasOne("SportSeeV2.Server.Data.UserPerformanceEntity", "UserPerformanceEntity")
                        .WithMany("Data")
                        .HasForeignKey("UserPerformanceEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserPerformanceEntity");
                });

            modelBuilder.Entity("SportSeeV2.Server.Data.SessionsEntity", b =>
                {
                    b.HasOne("SportSeeV2.Server.Data.UserAverageSessionsEntity", "UserAverageSessionsEntity")
                        .WithMany("Sessions")
                        .HasForeignKey("UserAverageSessionsEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserAverageSessionsEntity");
                });
